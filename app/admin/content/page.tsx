...
const PAGES: PageConfig[] = [
  ...
  },
  {
    ...
    sections: [
      {
        title: 'Hero Banner', fields: [
          { key: 'hero_image',    label: 'Hero Image',    type: 'image', default: '/Website Assets/About/Serious Group Photo.png' },
      ...
      },
      {
        title: 'About Us', fields: [
          ...
          { key: 'about_image', label: 'Photo',        type: 'image',    default: '/Website Assets/Group Photos/Smiling Group Photo %231.JPG' },
        ],
      },
      {
        ...
        <div key={section.title} className="admin-section" style={{ marginBottom: '1.5rem' }}>
          ...
          {section.fields.map(field => (
            <div key={field.key} className="admin-form-group">
              ...
              {field.type === 'image' ? (
                <ImageField value={values[field.key] ?? field.default} onChange={v => set(field.key, v)} bucket="images" folder="content/" />
              ) : field.type === 'textarea' ? (
                <textarea
